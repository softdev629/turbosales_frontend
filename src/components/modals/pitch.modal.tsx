...
const newPatchSchema = object({
  date: string(),
});

export type NewPatchSaveSchema = TypeOf<typeof newPatchSchema>;

const PitchModal = (props: {
  setOpen: (flag: boolean) => void;
  open: boolean;
}) => {
  const methods = useForm<NewPatchSaveSchema>({
    resolver: zodResolver(newPatchSchema),
  });
        ...
        <Box sx={style}>
          <Stack gap={3}>
            ...
            <Stack
              ...
              alignItems="center"
            >
              <Typography>Book the Pitch Meeting</Typography>
